...
public class PublicKeyHelperTest {
    ...
    @Test
    void shouldParseSSHRSAPublicKey() {
    ...
    @Test
    void shouldParseSSHRSAPublicKeyWithNoAlgorithm() {
        RSAPublicKey publicKey = PublicKeyHelper.parsePublicKey(
    ...
    @Test
    void shouldParseSSHRSAPublicKeyWithNoAlgorithmAndMail() {
        RSAPublicKey publicKey = PublicKeyHelper.parsePublicKey(
    ...
    @Test
    void shouldParseSSHRSA384PublicKey() {
        RSAPublicKey publicKey = PublicKeyHelper.parsePublicKey(
