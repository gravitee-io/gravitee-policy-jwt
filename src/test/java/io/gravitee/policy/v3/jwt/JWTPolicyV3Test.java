...
public abstract class JWTPolicyV3Test {
    ...
    @Test
    void test_with_gateway_keys_and_valid_authorization_header() throws Exception {
    ...
    @Test
    void test_with_gateway_keys_and_valid_lowercase_authorization_header() throws Exception {
        String jwt = getJsonWebToken(7200);
    ...
    @Test
    void test_get_client_with_client_id_claim() throws Exception {
        when(executionContext.getComponent(Environment.class)).thenReturn(environment);
        when(environment.getProperty("policy.jwt.issuer.gravitee.authorization.server.MAIN")).thenReturn(getSignatureKey());
        ...
        verify(executionContext, times(1)).setAttribute(JWTPolicyV3.CONTEXT_ATTRIBUTE_OAUTH_CLIENT_ID, "my-client-id");
    ...
    @Test
    void test_get_client_with_aud_claim() throws Exception {
        when(executionContext.getComponent(Environment.class)).thenReturn(environment);
        when(environment.getProperty("policy.jwt.issuer.gravitee.authorization.server.MAIN")).thenReturn(getSignatureKey());

        JWTClaimsSet.Builder builder = getJsonWebTokenBuilder(7200);
        builder.claim(JWTPolicyV3.CONTEXT_ATTRIBUTE_CLIENT_ID, "my-client-id");
        builder.claim(JWTPolicyV3.CONTEXT_ATTRIBUTE_AUDIENCE, "my-client-id-from-aud");
        ...
        verify(executionContext, times(1)).setAttribute(JWTPolicyV3.CONTEXT_ATTRIBUTE_OAUTH_CLIENT_ID, "my-client-id-from-aud");

        verify(policyChain, times(1)).doNext(request, response);
    }

    @Test
    void test_get_client_with_configuration() throws Exception {
        when(executionContext.getComponent(Environment.class)).thenReturn(environment);
        when(environment.getProperty("policy.jwt.issuer.gravitee.authorization.server.MAIN")).thenReturn(getSignatureKey());
    ...
    @Test
    void test_get_client_with_configuration_array() throws Exception {
        when(executionContext.getComponent(Environment.class)).thenReturn(environment);
        when(environment.getProperty("policy.jwt.issuer.gravitee.authorization.server.MAIN")).thenReturn(getSignatureKey());
    ...
    @Test
    void test_get_client_with_aud_array_claim() throws Exception {
        when(executionContext.getComponent(Environment.class)).thenReturn(environment);
        when(environment.getProperty("policy.jwt.issuer.gravitee.authorization.server.MAIN")).thenReturn(getSignatureKey());
    ...
    @Test
    void test_get_client_with_azp_claim() throws Exception {
        when(executionContext.getComponent(Environment.class)).thenReturn(environment);
        when(environment.getProperty("policy.jwt.issuer.gravitee.authorization.server.MAIN")).thenReturn(getSignatureKey());

        JWTClaimsSet.Builder builder = getJsonWebTokenBuilder(7200);
        builder.claim(JWTPolicyV3.CONTEXT_ATTRIBUTE_CLIENT_ID, "my-client-id");
        builder.claim(JWTPolicyV3.CONTEXT_ATTRIBUTE_AUTHORIZED_PARTY, "my-client-id-from-azp");
        ...
        verify(executionContext, times(1)).setAttribute(JWTPolicyV3.CONTEXT_ATTRIBUTE_OAUTH_CLIENT_ID, "my-client-id-from-azp");

        verify(policyChain, times(1)).doNext(request, response);
    }

    @Test
    void test_get_client_with_multiple_client_claims() throws Exception {
        when(executionContext.getComponent(Environment.class)).thenReturn(environment);
        when(environment.getProperty("policy.jwt.issuer.gravitee.authorization.server.MAIN")).thenReturn(getSignatureKey());

        JWTClaimsSet.Builder builder = getJsonWebTokenBuilder(7200);
        builder.claim(JWTPolicyV3.CONTEXT_ATTRIBUTE_CLIENT_ID, "my-client-id");
        builder.claim(JWTPolicyV3.CONTEXT_ATTRIBUTE_AUDIENCE, new String[] { "my-client-id-from-aud" });
        builder.claim(JWTPolicyV3.CONTEXT_ATTRIBUTE_AUTHORIZED_PARTY, "my-client-id-from-azp");
    ...
    @Test
    void test_get_client_without_client_claim() throws Exception {
        when(executionContext.getComponent(Environment.class)).thenReturn(environment);
        when(environment.getProperty("policy.jwt.issuer.gravitee.authorization.server.MAIN")).thenReturn(getSignatureKey());
        ...
        verify(executionContext, times(1)).setAttribute(JWTPolicyV3.CONTEXT_ATTRIBUTE_OAUTH_CLIENT_ID, null);

        verify(policyChain, times(1)).doNext(request, response);
    }

    @Test
    void test_with_given_key_and_valid_authorization_header() throws Exception {
        String jwt = getJsonWebToken(7200);
    ...
    @Test
    void test_with_given_key_using_EL_and_valid_authorization_header() throws Exception {
        String jwt = getJsonWebToken(7200);
    ...
    @Test
    void test_with_given_key_but_not_provided() throws Exception {
        String jwt = getJsonWebToken(7200);
    ...
    @Test
    void test_with_gateway_keys_and_valid_access_token() throws Exception {
        String jwt = getJsonWebToken(7200);
    ...
    @Test
    void test_with_gateway_keys_and_expired_header_token() throws Exception {
    ...
    @Test
    void test_with_gateway_keys_and_unknown_issuer() throws Exception {
    ...
    @Test
    void test_not_authentification_scheme() throws Exception {
        String jwt = getJsonWebToken(7200);
    ...
    @Test
    void test_with_jwks_url() throws Exception {
